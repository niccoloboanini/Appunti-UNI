...
Lunghezza minima intestazione: parte in rosso $\to$ 5 righe ciascuna di 4 byte (in tutto quindi 20 btye);
...
- Total length: specifica lunghezza effettiva in byte della testata - è lungo 15 bit


⚠: ogni blocco deve essere almeno di 4 bit!
