...
Andiamo perciò a trovare $Y(Z)$ per poi antitrasformare per ottenere l'uscita:
...
#### 2) EQUAZIONE ALLE DIFFERENZE FINITE CHE IMPLEMENTA IL SISTEMA
...
Esistono in tutto $4$ possibili strutture/casi che inducono ad avere una fase lineare:
...
\end{align*}
$$- nota: formule da controllare: soprattutto nel caso tre non dovrebbe apparire anche il campione centrale $h\left[\frac{N-1}{2}\right]$ prima della sommatoria (?)
