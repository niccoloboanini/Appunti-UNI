...
- al centro dell'intervallo (*arrotondamento*): si associa il livello più vicino al valore $x$ da quantizzare. Con questo metodo si commette meno erroe infatti: $\displaystyle |e| \leq \frac{\Delta}{2}$
