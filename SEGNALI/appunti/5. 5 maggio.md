...
>> Sappiamo che: $$ R_{ee}[m]=E[e[n] \ e[n+m]] = \begin{cases} \underbrace{E[e[n]]}_{0} \cdot \underbrace{E[e[n+m]]}_{0}=0, & m \neq 0 \\ E[e[n]] \cdot E[e[n]] = E[e^2[n]]=\frac{\Delta^2}{12}  ,& m=0 \end{cases} $$, ovvero riassumendo: $$ R_{ee}[m] = \frac{\Delta^2}{12} \cdot \underbrace{\delta[m]}_{\substack{\text{imp. discr.} \\ \text{unitario}}}  $$ ![[Pasted image 20220510163312.png|300]] Un processo con questa funzione di autocorrelazione viene detto **bianco**, infatti la sua densità spettrale di potenza (ovvero la trasformata di Fourier) è costante (periodica) e vale $\Delta^2/12$.
